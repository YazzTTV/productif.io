...
/**
 * Script pour tester la notification FOCUS_END
 * Envoie uniquement en push mobile
 * 
 * Usage: node scripts/test-notification-focus-end.js [userId]
 */
...
async function main() {
  try {
    ...
    console.log('⏱️ Test notification FOCUS_END\n');
    ...
    const payload = {
      ...
      badge: 1,
      data: {
        notificationId: `test_focus_end_${Date.now()}`,
        type: 'FOCUS_END',
