...
/**
 * Script pour tester la notification MOOD_CHECK_PREMIUM
 * Envoie uniquement en push mobile
 * 
 * Usage: node scripts/test-notification-mood-check-premium.js [userId]
 */
...
async function main() {
  try {
    ...
    console.log('🙂 Test notification MOOD_CHECK_PREMIUM\n');
    ...
    const payload = {
      ...
      badge: 1,
      data: {
        notificationId: `test_mood_check_premium_${Date.now()}`,
