/**
 * Script pour décoder GOOGLE_SERVICE_ACCOUNT_JSON_B64
 *
 * Usage :
 *   node scripts/decode-google-service-account.js
 *   node scripts/decode-google-service-account.js > service-account.json
 *
 * Prérequis :
