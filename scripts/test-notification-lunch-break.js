...
/**
 * Script pour tester la notification LUNCH_BREAK
 * Envoie uniquement en push mobile
 * 
 * Usage: node scripts/test-notification-lunch-break.js [userId]
 */
...
async function main() {
  try {
    ...
    console.log('🍽️ Test notification LUNCH_BREAK\n');
    ...
    const payload = {
      ...
      badge: 1,
      data: {
        notificationId: `test_lunch_break_${Date.now()}`,
        type: 'LUNCH_BREAK',
