...
/**
 * Script pour tester la notification FOCUS_WINDOW
 * Envoie uniquement en push mobile
 * 
 * Usage: node scripts/test-notification-focus-window.js [userId]
 */
...
async function main() {
  try {
    ...
    console.log('🎯 Test notification FOCUS_WINDOW\n');
    ...
    const payload = {
      ...
      badge: 1,
      data: {
        notificationId: `test_focus_window_${Date.now()}`,
        type: 'FOCUS_WINDOW',
