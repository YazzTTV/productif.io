...
import { Home, Brain, Settings, Clock, Users } from 'lucide-react';
import { motion } from 'framer-motion';
import { useRouter } from 'next/navigation';
import { useState, useEffect } from 'react';
import { CommunityProgressCard } from './community-progress-card';

interface DisciplineDashboardProps {
  userName: string;
}

export function DisciplineDashboard({ userName }: DisciplineDashboardProps) {
      ...
      <div className="px-6 space-y-6">
        ...
        >
          ...
          <div className="p-8 border-2 border-[#16A34A]/20 bg-gradient-to-br from-[#16A34A]/5 to-[#16A34A]/10 rounded-3xl shadow-lg shadow-[#16A34A]/5">
            ...
            >
              <Button
                onClick={() => handleNavigate('/dashboard/focus')}
        ...
        >
          <CommunityProgressCard onNavigate={handleNavigate} />
        </motion.div>
      ...
      >
        <div className="max-w-md mx-auto flex items-center justify-around">
          ...
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            onClick={() => handleNavigate('/dashboard/assistant-ia')}
