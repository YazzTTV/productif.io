    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex items-center justify-center py-12 px-8">
      ...
      {isMounted && (
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {[...Array(20)].map((_, i) => {
            const left = seededRandom(i + questionNumber * 1000) * 100
            const top = seededRandom(i + questionNumber * 2000) * 100
            const duration = 4 + seededRandom(i + questionNumber * 3000) * 2
            const delay = seededRandom(i + questionNumber * 4000) * 2
      ...
      <div className="max-w-3xl w-full relative z-10">
        ...
        <div className="mb-12">
          ...
          <motion.h2
            ...
            className="text-gray-900 leading-tight text-4xl text-center mb-4 font-bold"
          >
            {question}
          </motion.h2>
        </div>
