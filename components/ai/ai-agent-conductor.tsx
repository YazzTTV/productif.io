...
import { ArrowLeft, Calendar, Focus, ListChecks, BookOpen, GraduationCap, CheckSquare, ChevronRight } from 'lucide-react';
...
export function AIAgentConductor({ userName }: AIAgentConductorProps) {
  ...
  const handleStartFocus = () => {
    handleNavigate('/dashboard/focus');
  };
  ...
  if (view === 'main') {
    const actions = [
      ...
      },
      {
        ...
        icon: GraduationCap,
        label: 'Exam Mode',
        action: () => handleNavigate('/dashboard/exam'),
      },
      {
        id: 'tasks',
        icon: CheckSquare,
