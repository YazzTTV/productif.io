...
export function WorkStyleDiagnostic({
  ...
  const [overthinkTasks, setOverthinkTasks] = useState<boolean>(initialOverthink ?? false);
  const [shouldDoMore, setShouldDoMore] = useState<boolean>(initialShouldDoMore ?? false);
