      ...
      >
        <div className="text-center space-y-3">
          ...
          <h1 className="tracking-tight text-3xl font-bold" style={{ letterSpacing: '-0.04em' }}>
            {getTranslation('syncYourDay', 'Synchronisez votre journée')}
          </h1>
          <p className="text-black/60">{getTranslation('createEvents', 'Nous créons des événements pour votre plan.')}</p>
        </div>
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <div className="flex-1 text-left">
              <h3 className="tracking-tight" style={{ letterSpacing: '-0.02em' }}>
                {getTranslation('googleCalendar', 'Google Agenda')}
              </h3>
            </div>
          </motion.button>
          ...
          >
            ...
            <div className="flex-1 text-left">
              <h3 className="tracking-tight" style={{ letterSpacing: '-0.02em' }}>
                {getTranslation('appleCalendar', 'Calendrier Apple')}
              </h3>
            </div>
          </motion.button>
        </div>
        ...
        >
          ...
          >
            {getTranslation('skip', 'Passer pour le moment')}
          </button>
        </motion.div>
      </motion.div>
    </div>
