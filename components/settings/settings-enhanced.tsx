...
import { ChevronRight, Check, Bell, Clock, AlarmClock, LogOut } from 'lucide-react';
...
export function SettingsEnhanced({ userName = 'Student', userEmail = '', isPremium = false }: SettingsEnhancedProps) {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="px-6 pt-8 space-y-12 pb-24">
        ...
        >
          ...
          >
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div className="text-left">
                  <p className="font-medium text-lg mb-1">Current plan: {isPremium ? 'Premium' : 'Free'}</p>
                  <p className="text-sm text-black/60">
                    {isPremium 
        ...
        <div className="pt-8 pb-12 text-center space-y-4">
          ...
          >
            <div className="w-12 h-12 rounded-full bg-[#16A34A]/10 flex items-center justify-center">
              <span className="text-xl font-bold text-[#16A34A]">P</span>
            </div>
          </motion.div>
