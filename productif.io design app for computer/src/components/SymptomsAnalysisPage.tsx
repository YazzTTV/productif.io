      ...
      <div className="relative z-10 flex-1 flex flex-col max-w-4xl mx-auto w-full">
        ...
        >
          <p className="text-lg text-gray-700 text-center leading-relaxed">
            <span className="text-blue-600 text-2xl">💡</span> Based on your symptoms, we'll create a custom plan to boost your productivity
          </p>
        </motion.div>
        ...
        >
          <span className="text-2xl">Discover My Profile</span>
          <ArrowRight size={28} />
        </motion.button>
