  ...
  return (
    <div className="min-h-[844px] bg-white px-6 py-12 flex flex-col">
      ...
      <div className="flex-1 flex flex-col justify-center relative z-10 max-w-4xl mx-auto w-full px-8">
        ...
        >
          <p className="text-[#00C27A] text-xl mb-3">Your productivity profile</p>
          <h1 className="text-gray-900 text-5xl mb-2 flex items-center justify-center gap-3">
        ...
        >
          <div className="bg-green-50 rounded-2xl p-6 text-center border-2 border-green-200 shadow-md">
            <p className="text-green-600 text-3xl mb-2">+87%</p>
          ...
          <div className="bg-blue-50 rounded-2xl p-6 text-center border-2 border-blue-200 shadow-md">
            <p className="text-blue-600 text-3xl mb-2">3.2x</p>
          ...
          <div className="bg-purple-50 rounded-2xl p-6 text-center border-2 border-purple-200 shadow-md">
            <p className="text-purple-600 text-3xl mb-2">-64%</p>
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <h3 className="text-gray-900 text-2xl mb-6 text-center">Choose your plan</h3>
          ...
          >
            ...
            <div className="flex items-center justify-between mt-3">
              <div className="text-left">
                <p className="text-gray-900 text-xl mb-2">Annual Plan</p>
                <div className="flex items-center gap-2">
                  <span className="text-base text-green-600 bg-green-50 px-3 py-1 rounded-full">💰 Save $60/year</span>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="text-right">
                  <p className="text-gray-900 text-3xl">$9.99</p>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="text-left">
                <p className="text-gray-900 text-xl">Monthly Plan</p>
                <p className="text-base text-gray-500">Flexible billing</p>
              </div>
              <div className="flex items-center gap-4">
                <div className="text-right">
                  <p className="text-gray-900 text-3xl">$14.99</p>
                  <p className="text-base text-gray-500">per month</p>
                </div>
                <div className={`w-8 h-8 rounded-full border-2 flex items-center justify-center ${
                  selectedPlan === 'monthly'
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <p className="text-gray-900 text-xl">7-Day Free Trial</p>
          </div>
