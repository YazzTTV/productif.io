...
class ReactiveSchedulerManager {
    ...
    async start() {
        ...
        try {
            ...
            // Démarrer le BehaviorCheckInScheduler (import dynamique pour éviter erreurs)
            try {
                const { behaviorCheckInScheduler } = await import('./behavior/BehaviorCheckInScheduler.js');
                behaviorCheckInScheduler.start();
            } catch (e) {
                console.error('Erreur démarrage BehaviorCheckInScheduler:', e.message);
            }

            // Démarrer le TrialReminderScheduler
            try {
                const { trialReminderScheduler } = await import('./trial/TrialReminderScheduler.js');
                trialReminderScheduler.start();
            } catch (e) {
                console.error('Erreur démarrage TrialReminderScheduler:', e.message);
            }
    ...
    async stop() {
        ...
        try {
            ...
            try {
                const { behaviorCheckInScheduler } = await import('./behavior/BehaviorCheckInScheduler.js');
                behaviorCheckInScheduler.stop();
            } catch (e) {
                console.error('Erreur arrêt BehaviorCheckInScheduler:', e.message);
            }
            ...
            try {
                ...
                console.error('Erreur arrêt TrialReminderScheduler:', e.message);
            }
