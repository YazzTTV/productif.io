...
class DatabaseWatcher extends EventEmitter {
    ...
    async scan() {
        ...
        NotificationLogger.log('DEBUG', 'DATABASE_WATCHER_SCAN_START', {
            watcherId: this.watcherId,
            scanId,
        ...
        try {
            ...
            NotificationLogger.log('DEBUG', 'DATABASE_QUERY_COMPLETE', {
                scanId,
        ...
        if (!prevSettings && currSettings) {
            ...
            for (const field of fieldsToCheck) {
                if (prevSettings[field] !== currSettings[field]) {
                    ...
                    NotificationLogger.log('DEBUG', 'NOTIFICATION_SETTING_CHANGED', {
                        userId,
                        field,
                        from: prevSettings[field],
                        to: currSettings[field]
